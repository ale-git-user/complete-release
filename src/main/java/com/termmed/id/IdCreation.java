...
//			idc.execute();
	...
	public IdCreation(String componentFile,String uuidsMapFile, int namespaceId,
			long partitionId, String endPointURL, String username, String pass,
			String releaseDate) {
		super();
		this.componentFile = componentFile;
		this.uuidsMapFile=uuidsMapFile;
