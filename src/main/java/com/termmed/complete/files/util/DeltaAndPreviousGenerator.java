...
public class DeltaAndPreviousGenerator extends AbstractTask {
	...
	private File outputDeltaFile;
	private File outputPreviousFile;

	public DeltaAndPreviousGenerator(File sortedFile, String initialDate,
			String finalDate, int[] columnId, int effectiveTimeColumn,
			File outputDeltaFile, File outputPreviousFile) {
		super();
		...
		this.outputPreviousFile=outputPreviousFile;
	}
	...
	public void execute() throws IOException{
			...
			if (outputDeltaFile.exists()){
				outputDeltaFile.delete();
			}
			FileOutputStream fos = new FileOutputStream( outputDeltaFile);
			OutputStreamWriter osw = new OutputStreamWriter(fos,"UTF-8");
			BufferedWriter bw = new BufferedWriter(osw);
			bw.append(header);
			bw.append("\r\n");

			FileOutputStream fosp = new FileOutputStream( outputPreviousFile);
			OutputStreamWriter oswp = new OutputStreamWriter(fosp,"UTF-8");
